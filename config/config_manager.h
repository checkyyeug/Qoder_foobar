...
struct PlayerConfig {
    ...
    std::string history_file = "~/.qoder-foobar/history.json";
};
...
struct LogConfig {
    ...
    std::string log_file = "~/.qoder-foobar/qoder.log";
...
struct AppConfig {
    ...
    std::string playlist_directory = "~/.qoder-foobar/playlists";

    // 网络配置
    bool enable_network = false;
    bool check_updates = true;
    std::string update_server = "https://api.qoder-foobar.com";
};
