...
#include "foobar_sdk/input_decoder.h"
#include "mp_types.h"

using namespace mp::compat;
using namespace mp::compat::test;

// Test fixture for FoobarCompatManager
class FoobarCompatManagerTest : public TestFixture {
public:
    std::string getName() const override {
        return "FoobarCompatManagerTest";
    }
...
private:
    TestResult testServicePtr() {
        ...
        class TestService : public foobar2000_sdk::service_base {
        public:
        ...
        // Test construction
        foobar2000_sdk::service_ptr_t<TestService> ptr1;
        bool nullOnConstruct = ptr1.is_empty();
        
        // Test assignment
        foobar2000_sdk::service_ptr_t<TestService> ptr2(new TestService());
        bool notNullAfterAssign = !ptr2.is_empty();
        
        // Test copy constructor
        foobar2000_sdk::service_ptr_t<TestService> ptr3(ptr2);
    ...
    TestResult testAudioChunk() {
        foobar2000_sdk::audio_chunk chunk;
...
int main() {
    ...
    REGISTER_TEST_FIXTURE(FoobarCompatManagerTest);
