...
public:
    ...
    PluginInfo get_info() const override {
        PluginInfo info;
        info.name = "Qoder Sample Rate Converter DSP";
        info.version = "1.0.0";
        info.author = "Qoder Team";
...
public:
    ...
    PluginInfo get_info() const override {
        PluginInfo info;
        info.name = "Qoder Sample Rate Converter DSP Factory";
        info.version = "1.0.0";
        info.author = "Qoder Team";
...
// 导出插件
QODER_EXPORT_DSP_PLUGIN(ResamplerDSPPlugin)