...
int main() {
    std::cout << "\n=== Qoder foobar Resampler Improvement Proposal ===\n\n";
    ...
    std::cout << "┌─────────────────────┬─────────────┬─────────────┐\n";
    std::cout << "│ Metric              │ Qoder foobar │ foobar2000  │\n";
    std::cout << "├─────────────────────┼─────────────┼─────────────┤\n";
    ...
    std::cout << "Qoder foobar has excellent performance and broader sample rate\n";
    ...
    std::cout << "The proposed improvements will make Qoder foobar a truly\n";
