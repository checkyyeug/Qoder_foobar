...
// 导出插件
QODER_EXPORT_AUDIO_PLUGIN(qoder::plugins::OggVorbisDecoder)

// 自动注册解码器
QODER_AUTO_REGISTER_DECODER(qoder::plugins::OggVorbisDecoder, {"ogg", "oga", "vorbis"})