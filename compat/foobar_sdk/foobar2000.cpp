...
namespace service_ids {
    ...
    const guid_playback_control_v2 = {0x6DC56043, 0x29E6, 0x488B, {0x96, 0xDA, 0x9C, 0x7D, 0x9B, 0xA4, 0xB8, 0x7D}};
}
...
bool service_query_t FOOBAR2000_GUID service_query(const GUID& guid, void** out) {
